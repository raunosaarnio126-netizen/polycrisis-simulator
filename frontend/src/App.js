    ...
    switch (document.type) {
        ...
        return (
          <div className="space-y-4">
            ...
            {document.data?.scenarios && (
              <div className="space-y-3">
                {document.data.scenarios.map((scenario, index) => (
                    ...
                    {scenario.choices && (
                      <div className="mt-3 space-y-2">
                        {scenario.choices.map((choice, choiceIndex) => (
                          <div key={choiceIndex} className="text-sm p-2 bg-white rounded border">
                            <strong>Option {choiceIndex + 1}:</strong> {choice.text}
                            {choice.consequence && (
      ...
      case 'action-plan':
        return (
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">{document.title}</h3>
            {document.data?.phases && (
              <div className="space-y-4">
                {document.data.phases.map((phase, index) => (
                  <div key={index} className="border rounded-lg p-4">
                    <h4 className="font-medium text-gray-800 mb-2">{phase.name}</h4>
        ...
        return (
          <div className="space-y-4">
            ...
            {document.data?.strategies && (
              <div className="space-y-3">
                {document.data.strategies.map((strategy, index) => (
        ...
        return (
          <div className="space-y-4">
            ...
            {document.data?.agents && (
              <div className="space-y-3">
                {document.data.agents.map((agent, index) => (
                  <div key={index} className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="flex items-center gap-2 mb-2">
                      <Monitor className="w-4 h-4 text-blue-600" />
                      <h4 className="font-medium text-blue-800">{agent.name}</h4>
                    </div>
                    <p className="text-sm text-blue-700 mb-2">{agent.description}</p>
                    {agent.monitoring_tasks && (
                      <div className="space-y-1">
                        {agent.monitoring_tasks.map((task, taskIndex) => (
                          <div key={taskIndex} className="text-xs text-blue-600 flex items-center gap-1">
        ...
        return (
          <div className="space-y-4">
            ...
            {document.data?.systems && (
              <div className="space-y-3">
                {document.data.systems.map((system, index) => (
                  <div key={index} className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                    <div className="flex items-center gap-2 mb-2">
                      <Network className="w-4 h-4 text-purple-600" />
                      <h4 className="font-medium text-purple-800">{system.name}</h4>
                    </div>
                    <p className="text-sm text-purple-700 mb-2">{system.description}</p>
                    {system.components && (
                      <div className="grid grid-cols-2 gap-2 mt-3">
                        {system.components.map((component, compIndex) => (
                          <div key={compIndex} className="text-xs p-2 bg-white rounded border border-purple-100">
                            {component}
                          </div>
                        ))}
                      </div>
                    ...
                    {insight.recommendations && (
                      <div className="mt-3 space-y-1">
                        {insight.recommendations.map((rec, recIndex) => (
                          <div key={recIndex} className="text-xs text-green-600 flex items-start gap-1">
                ...
                {document.data.sources.map((source, index) => (
                  <div key={index} className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="font-medium text-orange-800">{source.name}</h4>
                    </div>
          ...
          <div className="space-y-4">
            ...
            {document.data?.metrics && (
              <div className="grid grid-cols-2 gap-4">
                {Object.entries(document.data.metrics).map(([key, value], index) => (
